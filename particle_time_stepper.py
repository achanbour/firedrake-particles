...
class ForwardEulerStepper(ParticleTimeStepper):
    ...
    def __init__(self, particle_vom, dt, v):
        ...
        # Define and store the symbolic expression for the velocity pullback
        # This gets re-evaluated every time the update expression gets re-evaluated in stepper.step()
